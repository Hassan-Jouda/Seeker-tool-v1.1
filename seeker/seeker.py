...
META_URL = 'https://raw.githubusercontent.com/Hassan Jouda/seeker tool v1.1/master/metadata.json'
...
def banner():
	with open(META_FILE, 'r') as metadata:
		...
		twitter_url = json_data['facebook']
		comms_url = json_data['Whatsapp']
...
/____  > \___  >\___  >|__|_ \ \___  >|__|
     \/      \/     \/      \/     \/'''
	print(f'{G}{art}{W}\n')
	print(f'{G}[>] {C}Created By   : {W}Dark Storm{W}\n')
	print(f'{G} |---> {C}Twitter   : {W}{twitter_url}')
	print(f'{G} |---> {C}Community : {W}{comms_url}')
	print(f'{G}[>] {C}Version      : {W}{VERSION}\n')
	print(f'{G}[>] {C}نصيحة يا حلو      : {W}خليك اخلاقي{W}\n')
